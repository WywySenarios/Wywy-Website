...
static const cyaml_schema_field_t reference_urls_schema[] = {
    CYAML_FIELD_STRING_PTR("main", CYAML_FLAG_POINTER, struct reference_urls,
                           main, 0, CYAML_UNLIMITED),
    CYAML_FIELD_STRING_PTR("db", CYAML_FLAG_POINTER, struct reference_urls, db,
                           0, CYAML_UNLIMITED),
    CYAML_FIELD_END};
